...
def main():
    calc_train = pd.read_csv("../../data/cbis-ddsm/calc_case_description_train_set.csv")
    mass_train = pd.read_csv("../../data/cbis-ddsm/mass_case_description_train_set.csv")
    meta = pd.read_csv("../../data/cbis-ddsm/manifest-ZkhPvrLo5216730872708713142/metadata.csv")
